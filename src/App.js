...
const App = () =>{
  ...
  function onSignup(){
    ...
    .then((confirmationResult) => {
      ...
      setLoading(false);
      setShowOTP(true);
      toast.success('OTP sendes successfully!');
      // ...
    }).catch((error) => {
      // Error; SMS not sent
      // ...
    ...
    <div id='recaptcha-container'></div>
    {
      ...
      :<div className=' w-80 flex flex-col gap-4 rounded-lg p-4'>
         <h1 className='text-center leading-normal text-white font-medium text-3xl mb-6'>
          Welcome to <br/>  ANUSHKA UNIYAL PROJECT
         </h1> 
         {
showOTP ?
        <>
          ...
          <button onClick={onOTPVerify} className='bg-orange-500
           w-full flex gap-1 items-center justify-center py-2.5 text-white roundeds'>
        ...
        <>
         ...
         <PhoneInput country={"in"} value={ph} onChange={setPh}/>
          <button onClick={onSignup} className='bg-orange-500 w-full flex gap-1 items-center justify-center py-2.5 text-white roundeds'>
          { loading &&  <CgSpinner size={20} className='mt-1 animate-spin' />}
